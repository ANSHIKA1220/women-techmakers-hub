...
// FIX: Removed API key prompt logic to align with @google/genai guidelines.
// The API key should be managed via environment variables (process.env.API_KEY) and not through the UI.
const App = () => {
  return (
